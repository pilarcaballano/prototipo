...
import { AcceptDialogComponent } from 'src/app/dialogs/accept-dialog/accept-dialog.component';
...
// import { ComunicacioncorreoService } from 'src/app/core/com-correo/comunicacioncorreo.service.js';


@Component({ 
  selector: 'cuadro-com-correo-solicitudes-pendientes',
...
export class SolicitudesPdtsComponent implements OnInit {
  ...
  constructor(
    // public dialogRef: MatDialogRef<SolicitudesPdtsComponent>,
